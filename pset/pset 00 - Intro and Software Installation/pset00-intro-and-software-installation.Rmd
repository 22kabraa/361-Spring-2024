...
g = ggplot(iris, aes(x = Petal.Width, y = Petal.Length)) + geom_point() + ggtitle("Aditya Kabra's animation")
g

a = g + transition_states(Species,transition_length = 2,state_length = 1)

a  ## check that the animation works

## save the animation
anim_save(a, filename = "img/test animations.gif")
```
