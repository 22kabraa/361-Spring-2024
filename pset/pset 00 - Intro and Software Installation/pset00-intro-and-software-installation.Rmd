...
![](/Users/adityakabra/S&DS361/Quiz.png)
...
g = ggplot(iris, 
           aes(x = Petal.Width, 
               y = Petal.Length)) + 
  geom_point() + 
  ggtitle("Aditya Kabra's animation")
g
```
```{r}
a = g + 
...
![](/Users/adityakabra/img/test animation.png)
...
```{r}
# My Github username is 22kabraa and was submitted! 
```
...
![](/Users/adityakabra/img/snip of GitHub Desktop.png)
...
![](/Users/adityakabra/img/snip of GitHub Copilot.png)
